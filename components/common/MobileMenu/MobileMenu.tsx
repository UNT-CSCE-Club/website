    ...
    <div className='flex h-screen overflow-hidden bg-white md:hidden'>
      <Transition.Root show={show} as={Fragment}>
        ...
        >
          ...
          >
            <div className='relative flex flex-col flex-1 w-full max-w-xs bg-white divide-y-2 shadow-2xl dark:bg-gray-800 dark:divide-gray-700 ring-1 ring-black ring-opacity-5 dark:ring-gray-600 divide-gray-50'>
              <Transition.Child
                as={Fragment}

    ...
    <div className='py-6'>
      <div className='md:flex md:justify-between md:space-x-6'>
        ...
        {has.digital_fulfillment && (
          <div className='w-full space-y-3 md:w-1/2 md:flex md:items-end md:justify-end md:space-y-0 md:space-x-3'>
            {fulfillment.digital.downloads.map((download, index) => (
              <div
                className='space-y-3 md:flex md:space-y-0 md:space-x-3'
                key={index}
              >
